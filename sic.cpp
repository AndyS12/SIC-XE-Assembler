...
string algorithm_pass1()
{
    bool error_flag=false;
    ifstream fp("prob.txt");
                ...
                while(1)
                {
                    ...
                    if(s.size()>0)
                    {
                        ...
                        if(mymap.count(label)==0)
                        {
                            ...
                            //Here think about how to execute comment line

                            //Handling Symbols

                            //cout<<label<<" "<<inst<<" "<<arguments<<endl;
                           ...
                           else if(inst=="BYTE")  //Check if this block is correct::May add wrong amount to loc
                           {
                               if(arguments[0]=='C')
                                    loc=convert_loc("",loc_decimal,3);
...
void algorithm_pass2()
{
    ...
    ofstream fp2("opcode_optput.txt");
